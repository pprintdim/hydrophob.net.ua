...
$_['text_newsletter_toggle'] = 'Получать новости и акции на почту';
$_['text_saved'] = 'Сохранено';
$_['button_save'] = 'Сохранить';
$_['text_email_change_hint'] = 'Чтобы изменить e-mail, введите новый адрес — пришлём код подтверждения.';
